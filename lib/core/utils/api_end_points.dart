class ApiEndpoints {
  static const String baseUrl = 'https://api.velozaje.com/api/v1/';
  static const String socketUrl = 'https://api.velozaje.com/';
  static const String baseImageUrl = 'https://api.velozaje.com/';
